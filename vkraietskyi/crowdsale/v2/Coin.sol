...
contract Coin {
    ...
    function approveAndCall(address spender, uint amount, bytes _extraData) returns (bool success) {
        allowed[msg.sender][spender] = amount;
        Approval(msg.sender, spender, amount);
        return Recipient(spender).receiveApproval(msg.sender, amount, this, _extraData);
    }
